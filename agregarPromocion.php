        ...
        <div class="col-4">
            <div class="card">
                <div class="card-header">
                    Ingresar datos para Promocion : <br><?php echo $persona->nombres.' '.$persona->apellido_paterno.' '.$persona->apellido_materno.' '.$persona->celular; ?>
                </div>
                <form class="p-4" method="POST" action="registrarPromocion.php">
                    ...
                    <div class="mb-3">
                         <label class="form-label">Validez de Promocion: </label>
